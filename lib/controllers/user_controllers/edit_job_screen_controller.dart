...
class EditJobScreenController extends GetxController {
  ...
  void onInit() {
    ...
    selectedHours = DateTime.parse("2025-12-15T13:00:00.000Z").hour.toString().padLeft(2, '0');
    selectedMints = DateTime.parse("2025-12-15T13:00:00.000Z").minute.toString().padLeft(2, '0');
