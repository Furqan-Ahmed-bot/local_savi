...
class _ChatScreenState extends State<ChatScreen> {
  ...
  // PHomeController phController = Get.find();
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  if (hsController.userdata.userType == "USER") ...[
                    Container(
                                                            ...
                                                            content: SizedBox(
                                                              ...
                                                              child: Column(
                                                                ...
                                                                children: [
                                                                  ...
                                                                  24.h.verticalSpace,
                                                                  Text(
                                                                    "Are you sure you to want select ${controller.username} for your job?",
                                                                    textAlign:
                                                                        TextAlign
                                                                            .center,
                                                                    maxLines: 2,
                  ...
                  : 
                       ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return chatController.allMessages[index][0]
                                        ['recipient_id'] !=
                          ...
                          InkWell(
                            onTap: () {
                              showModalBottomSheet(
                                context: context,
                                isScrollControlled:
                                    true, // Allows the bottom sheet to resize based on content
                                backgroundColor: Colors
                                    .transparent, // Makes the sheet background transparent for rounded corners
                                builder: (_) {
                                  return Padding(
