                              ...
                              : controller.names[controller.selectedIndex.value] == "Ongoing"
                                              ...
                                              (index) => GestureDetector(
                                                  onTap: () {
                                                    Get.toNamed(RouteName.ongoingJobDetailScreenPath,
                                                        arguments: {"jobId": controller.ongoingJobsList[index].id});
                                                  },
                                                  child: activeJobCard(
                                  ...
                                  : controller.names[controller.selectedIndex.value] == "Completed"
                                      ...
                                      : controller.cancelledJobsList.isEmpty
                                          ? const Center(child: Text(" No Cancelled Jobs Available"))
                                          : Column(
                                              children: List.generate(
                                                  ...
                                                  (index) => GestureDetector(
                                                        onTap: () {
                                                          Get.toNamed(RouteName.cancelledJobScreenPath,
                                                              arguments: {"jobId": controller.cancelledJobsList[index].id, "isPending": false});
                                                        },
                                                        child: Container(
                                                          width: 1.0.sw,
