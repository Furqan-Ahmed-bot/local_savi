...
//       };
//       var request = http.Request('POST', Uri.parse(ProfessionalUrls.loginUrl));
...
//         //     'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjBmYmE2OGY5LWYzMzQtNDVkNy05YmY2LTk1NzgyZDcxMzNlMCIsInR5cGUiOiJVU0VSIiwiaWF0IjoxNzMxNzM3MTQyLCJleHAiOjE3MzE4MjM1NDJ9.Ya5vgz1bSOAhseIU5AyoS65RrMOM26fcKof_wiIRDaw'
//       };
//       var request = http.Request('POST', Uri.parse(ProfessionalUrls.signupUrl));
//       request.body = json.encode({
//         "identifier": emailAddress,
//         "user_type": "PROFESSIONAL",
//         "password": password,
//         "request_type": "FIRST-OTP"
//       });
//       request.headers.addAll(headers);
...
//       };
//       var request =
//           http.Request('POST', Uri.parse(ProfessionalUrls.verifyOTPUrl));
//       request.body = json.encode({
//         "identifier": email,
...
//       };
//       var request =
//           http.Request('POST', Uri.parse(ProfessionalUrls.resendOTPUrl));
...
//       };
//       var request =
//           http.Request('POST', Uri.parse(ProfessionalUrls.forgetPasswordUrl));
//       request.body = json.encode({"identifier": email});
//       request.headers.addAll(headers);
...
//       };
//       var request =
//           http.Request('POST', Uri.parse(ProfessionalUrls.resetPasswordUrl));
...
//           'POST', Uri.parse(ProfessionalUrls.createProfileUrl));
...
//       var headers = {'Authorization': token.value};
//       var request =
//           http.Request('GET', Uri.parse(ProfessionalUrls.getProfileUrl));
