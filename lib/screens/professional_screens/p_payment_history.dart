...
class ProviderPaymentHistoryScreen extends StatefulWidget {
  @override
  _ProviderPaymentHistoryScreenState createState() => _ProviderPaymentHistoryScreenState();
}

class _ProviderPaymentHistoryScreenState extends State<ProviderPaymentHistoryScreen> {
  final controller = Get.put(PaymentHistoryController());
  final walletController = Get.put(PaymentMethodController());

  @override
  void initState() {
    walletController.getAccountBalance();
    walletController.getAllTranscations('CREDIT');
    super.initState();
  }
                    ...
                    : Column(
                        children: [
                          buildWalletBalanceCard(
                            context,
                            balance: '\$${walletController.totalAmount.value}',
                            // onTransfer: () {
                          ...
                          SizedBox(
                            ...
                            child: ListView.separated(
                              ...
                              itemBuilder: (_, i) => InkWell(
                                onTap: () {
                                  String formattedDate = dateFormat.formatCreatedAt(walletController.allTranscations[i]['createdAt']);
                                  showDialog(
                                    context: context,
                                              ...
                                              Row(
                                                ...
                                                children: [
                                                  ...
                                                  InkWell(
                                                    ...
                                                    child: Container(
                                                      decoration: BoxDecoration(color: Color(0xFF00000091), borderRadius: BorderRadius.circular(7.r)),
                                                      child: Image.asset(
                                                        ImageAssets.cutIcon,
                                                        scale: 2,
                                                      ),
                                                  ...
                                                  children: [
                                                    ...
                                                    Flexible(
                                                      child: InkWell(
                                                        ...
                                                        child: Text(
                                                          "${walletController.allTranscations[i]['jobs']['title']}",
                                              ...
                                              Container(
                                                ...
                                                child: Row(
                                                  ...
                                                  children: [
                                                    ...
                                                    Flexible(
                                                      child: Text(
                                                        "\$ ${walletController.allTranscations[i]['amount']}",
                                                        textAlign: TextAlign.end,
                                                        style: TextStyle(
                                                          color: ColorUtils.black,
                                                          fontWeight: FontWeight.bold,
                                ...
                                child: transactionTile(context, walletController.allTranscations[i]),
                              ),
                              ...
                              itemCount: walletController.allTranscations.length,
                            ),
                          )
